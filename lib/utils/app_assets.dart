abstract class AppAssets {
  ...
  static const iconAhadeth = "${imagePath}icon_hadeth.png";
  static const iconSebha = "${imagePath}icon_sebha.png";
  ...
  static const bodySebha = "${imagePath}body_sebha_logo.png";
  static const bodySebhaDark = "${imagePath}body_sebha_dark.png";
