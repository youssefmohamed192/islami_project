  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      bodyMedium: TextStyle(
          fontSize: 30, fontWeight: FontWeight.normal, color: AppColors.accent),
      ...
      titleSmall: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: AppColors.primary),
      labelLarge: TextStyle(fontWeight: FontWeight.normal, fontSize: 20, color: AppColors.accent),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    primaryColor: AppColors.primaryDark,
      ...
      textTheme: const TextTheme(
          ...
          bodyMedium: TextStyle(
              fontSize: 30, fontWeight: FontWeight.normal, color: AppColors.white),
          bodySmall: TextStyle(fontSize: 24, color: AppColors.accentDark),
          titleLarge: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,color: AppColors.white),
          titleMedium: TextStyle(fontWeight: FontWeight.bold, fontSize: 24,color: AppColors.primaryDark),
          titleSmall: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: AppColors.primaryDark),
        labelLarge: TextStyle(fontWeight: FontWeight.normal, fontSize: 20, color: AppColors.accentDark),
      ),
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
